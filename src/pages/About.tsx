                    ...
                    <CardContent className="p-4 text-center">
                      ...
                      <div className="flex items-center justify-center gap-2 mb-2">
                        ...
                        <div className="flex gap-1">
                          {ci.linkedin && (
                            <button
                              onClick={() => window.open(ci.linkedin, "_blank")}
                          ...
                          {ci.unsw && (
                            <button
                              onClick={() => window.open(ci.unsw, "_blank")}
                              className="bg-[#FECB00] text-black p-1 rounded-full hover:bg-[#E5B700] transition-colors duration-300 hover:scale-110 transform"
                              aria-label="Visit UNSW Staff Page"
                            >
                              <svg className="w-3 h-3" viewBox="0 0 24 24" fill="currentColor">
